...
if($username == "admin" or $username == "remunerasifisipui" or $username == "indra" or $username == "depkom"){ //report untuk admin
...
$pdf->Cell(20);
$pdf->Cell(57,8,'Kurang/Lebih Bayar Bulan Sebelumnya',0,0,'L');
$pdf->Cell(3,8,':',0,0,'L');
...
$pdf->Cell(20);
$pdf->Cell(52,8,'Total Honor Xf',0,0,'L');
$pdf->Cell(3,8,':',0,0,'L');
...
$pdf->Cell(20);
$pdf->Cell(52,8,'Honor Pengajaran Berbahasa Asing',0,0,'L');
$pdf->Cell(3,8,':',0,0,'L');
$pdf->Cell(20, 8, number_format($honor_bhs_asing), 0, 0, 'R');
$pdf->Cell(20);
...
$pdf->Cell(20);
$pdf->Cell(52,8,'Honor Bimbingan dan Insentif',0,0,'L');
$pdf->Cell(3,8,':',0,0,'L');
...
$pdf->Cell(20);
$pdf->Cell(52,8,'Potongan',0,0,'L');
$pdf->Cell(3,8,':',0,0,'L');
$pdf->Cell(20, 8, number_format($potongan), 0, 0, 'R');
...
if ($rows > 0){
	...
	#buat header tabel
	$pdf->SetFont('Arial','I','8');
	$pdf->Cell(0,4, 'Rincian Honor Bimbingan dan Insentif', '0', 1, 'L');	
	$pdf->SetFont('Arial','B','8');
	$pdf->SetFillColor(215,225,245);
	$pdf->SetTextColor(0);
	$pdf->SetDrawColor(215,225,245);
