...
//$sql = "select * from data where flagtampil=1 order by nip+kodekelas";
$sql = "select * from data order by nip+kodekelas";
...
xlsWriteLabel(2,0,"");
xlsWriteLabel(3,0,"KALKULATOR BEBAN PERIODE ... 2011");
...
xlsWriteLabel(5,44,"Periode");
xlsWriteLabel(5,45,"FlagAep");
$xlsRow = 6;
...
while($row=mysql_fetch_array($result)){
	...
	xlsWriteLabel($xlsRow,44,$row['Periode']);
	xlsWriteLabel($xlsRow,45,$row['FlagAep']);
