...
$judullaporan = "Realisasi Honor Pengajaran Semester $semester Tahun Akademik $tahunakademik";
...
if ($_SESSION['hak_akses'] == 1){	
	...
	if ($semester == "Gasal"){
		...
		$query = "SELECT NamaMataKuliah, NamaKelas, NamaPengajar,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='09',totalhonor,0)) as HadirSeptember,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='10',totalhonor,0)) as HadirOktober,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='11',totalhonor,0)) as HadirNovember,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='12',totalhonor,0)) as HadirDesember,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun+1 and bulan='01',totalhonor,0)) as HadirJanuari,
					KehadiranSeharusnya
				FROM kalban
				WHERE $kodeorganisasi and a.tahun_akad = $tahun_akad and semester = $smt and ikuthitung=1 and flagaep=0 and flagtampil=1 and
					 kodepdpt=0 and (kodepasca='0' or kodepasca='')
				group by kode
				order by NamaMataKuliah, NamaKelas, NamaPengajar";
	} else {

		$query = "SELECT NamaMataKuliah, NamaKelas, NamaPengajar, 
					sum(if(tahun_akad=$tahun_akad and  tahun=$tahun and bulan='02',totalhonor,0)) as 'HadirFebruari',		   
					sum(if(tahun_akad=$tahun_akad and  tahun=$tahun and bulan='03',totalhonor,0)) as 'HadirMaret',		   
					sum(if(tahun_akad=$tahun_akad and  tahun=$tahun and bulan='04',totalhonor,0)) as 'HadirApril',		   
					sum(if(tahun_akad=$tahun_akad and  tahun=$tahun and bulan='05',totalhonor,0)) as 'HadirMei',		   
					sum(if(tahun_akad=$tahun_akad and  tahun=$tahun and bulan='06',totalhonor,0)) as 'HadirJuni',
					KehadiranSeharusnya
				FROM kalban
				WHERE $kodeorganisasi and tahun_akad = $tahun_akad and semester = $smt and ikuthitung=1 and flagaep=0 and flagtampil=1 and
					  kodepdpt=0 and (kodepasca='0' or kodepasca='')
				group by kode
				order by NamaMataKuliah, NamaKelas, NamaPengajar";
	...
	if ($semester == "Gasal"){
		//jika semester gasal
		$query = "SELECT NamaMataKuliah, NamaKelas, NamaPengajar,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='09',totalhonor,0)) as honorseptember, 
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='10',totalhonor,0)) as honoroktober, 
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='11',totalhonor,0)) as honornopember,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun and bulan='12',totalhonor,0)) as honordesember,
					sum(if(tahun_akad=$tahun_akad and tahun=$tahun+1 and bulan='01',totalhonor,0)) as honorjanuari,
					KehadiranSeharusnya
				FROM kalban
				WHERE $kodeorganisasi and tahun_akad = $tahun_akad and semester = $smt and ikuthitung = 1 and flagaep = 0 and flagtampil = 1 and
					 kodepdpt = 0 and (kodepasca='0' or kodepasca='' or kodepasca='1')
				group by kode
				order by NamaMataKuliah, NamaKelas, NamaPengajar";
