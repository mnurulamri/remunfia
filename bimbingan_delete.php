	...
	<form method="post" action="bimbingan_crud.php" name="form1" id="form1">
		...
		<table border="0" cellpadding="3" cellspacing="0" id="center">
			...
			<tr>
				...
				<td id="label">NIP</td>
				<td>:</td>
				<td><input type="text" name="nip" value="<?echo $row['nip']?>" id="nip" class="ui-widget ui-widget-content padding ui-corner-all"></td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="3" align="center"><input type="button" value="Delete" name="submit" id="submit" class="button"/>
			</tr>
