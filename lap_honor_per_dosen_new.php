...
if($_SESSION['hak_akses'] == 1){
	...
	$query = "SELECT  a.nip as nip,
			...
			c.tj_keluarga as tj_keluarga,
			c.tj_fungsional as tj_fungsional,
			c.insentif_kehadiran as insentif_kehadiran,
			c.honor_menguji as honor_menguji,
	...
	switch ($skema){
		case 0: 
			$skema = "Skema Lain";
			$tunjangan_skema = 0;
			$honor_Xf = $tot_xf_skema_lain;
			break;
		case 1: 
			$skema = "Skema Inti Pengajaran";
			$tunjangan_skema = $ts_inti_pengajaran;
	...
	$pdf->Cell(3,8,':',0,0,'L');
	$pdf->Cell(20,8, number_format($insentif_kehadiran), 0, 1, 'R');
	$pdf->Cell(3);
	$pdf->Cell(52,8,'Tunjangan Keluarga',0,0,'L');  //fix
	$pdf->Cell(3,8,':',0,0,'L');
	$pdf->Cell(20, 8, number_format($tj_keluarga), 0, 0, 'R');
	$pdf->Cell(20);
	$pdf->Cell(52,8,'Total Honor Xf '.$skema,0,0,'L');
	$pdf->Cell(3,8,':',0,0,'L');
	$pdf->Cell(20, 8, number_format($total_xf), 0, 0, 'R');
	$pdf->Cell(20);
	...
	$pdf->Cell(3,8,':',0,0,'L');
	$pdf->Cell(20, 8, number_format($tj_fungsional), 0, 0, 'R');
	$pdf->Cell(20);
	$pdf->Cell(52,8,'Total Honor Menguji',0,0,'L');
	$pdf->Cell(3,8,':',0,0,'L');
	$pdf->Cell(20, 8, number_format($honor_menguji), 0, 0, 'R');
	$pdf->Cell(20);
	...
	$pdf->Cell(3,8,':',0,0,'L');
	$pdf->Cell(20, 8, number_format($kl_bayar), 0, 1, 'R');
	$pdf->Cell(3);
