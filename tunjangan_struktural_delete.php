...
<?php
	...
	$id = $_GET['id'];	
	$sql = "SELECT id, a.nip as nip, nama_pengajar, jabatan, tunjangan, periode
	...
	<form method="post" action="tunjangan_struktural_crud.php" name="form1" id="form1">
		...
		<table border="0" cellpadding="3" cellspacing="0" id="center">
			...
			<tr>
				...
				<td>:</td>
				<td><input type="text" name="tunjangan" id="tunjangan" value="<?echo number_format($row['tunjangan'])?>" onkeypress="return isNumberKey(event)" size="20" maxlength="10" onblur="return formatCurrency(this.value,0,',','','','','','')" class="ui-widget ui-widget-content padding ui-corner-all" style="text-align: right;"></td>
				<td colspan="3" align="center">
					<input type="button" name="submit" id="submit" value="delete" class="button"/>
